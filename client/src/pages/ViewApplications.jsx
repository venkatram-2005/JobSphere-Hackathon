                        ...
                        {applicants.filter(item => item.jobId && item.userId).map((applicant, index) => (
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b text-center flex'>
                                    ...
                                    <span className='py-2 px-4 text-center'>{applicant.userId.name}</span>
                                </td>
                                    ...
                                    {applicant.status === "Pending"
                                        ? <div className='relative inline-block text-left group' >
                                            ...
                                            <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block'>
                                                <button onClick={() => changeJobApplicationStatus(applicant._id, 'Accepted')} className='w-full block text-left px-4 py-2 text-blue-500 hover:bg-gray-100'>Accept</button>
                                                <button onClick={() => changeJobApplicationStatus(applicant._id, 'Rejected')} className='w-full block text-left px-4 py-2 text-red-500 hover:bg-gray-100'>Reject</button>
                                            </div>
                                        </div>
